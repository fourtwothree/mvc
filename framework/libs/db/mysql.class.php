...
class mysql
{
  ...
  /**
   * 连接数据库
   * @param  array $config 配置数组 array($dbhost, $dbuser, $dbpsw, $dbname, $dbcharset)
  ...
  function connect($config)
  {
    ...
    mysql_query("set names ".$dbcharset);//使用mysql_query设置编码格式：mysql_query("set names utf8")
  }
  ...
  function findAll($query)
  {
    ...
    {
      //mysql_fetch_array函数把资源转换为数组，一次转换一行出来
      $list[] = $rs;
    }
